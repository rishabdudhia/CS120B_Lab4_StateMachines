...
tests = [ 
    {'description': 'PINA: 0x01, 0x00, 0x02 => PORTB: 0x02',
    ...
    {'description': 'PINA: 0x01, 0x00, 0x01 0x00 , 0x01 => PORTB: 0x01',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 2 },
        {'inputs': [('PINA',0x00)], 'iterations': 100 },
        {'inputs': [('PINA', 0x01)], 'iterations': 2},
        {'inputs': [('PINA', 0x00)], 'iterations': 2},
    ...
    {'description': 'PINA: 0x01, PINA: 0xFF => PORTB: 0x01',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 2 },
        {'inputs': [('PINA',0xFF)], 'iterations': 100 }],
    'expected': [('PORTB',0x01)],
    },
    {'description': 'PINA: 0x01, 0xC1, 0x00, 0x04 , 0x05 => PORTB: 0x02',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 2 },
